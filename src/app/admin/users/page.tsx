    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-400">
              {isAdmin ? "Listado completo de usuarios." : "Clientes registrados en la tienda."}
            </p>
          </div>
        ...
        <section className="mt-8">
          <div className={`grid gap-3 ${isAdmin ? "md:grid-cols-5" : "md:grid-cols-3"}`}>
                ...
                {users.map((u) => {
                  ...
                  return (
                    <tr key={u.id} className="text-sm">
                      ...
                      <td className="px-4 py-3 text-zinc-400">{new Date(u.createdAt).toLocaleString("es-AR")}</td>
                    </tr>
                  );
                })}
                {users.length === 0 && (
